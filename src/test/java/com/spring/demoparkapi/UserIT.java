...
public class UserIT {
    ...
    @Test
    public void createUser_WithInvalidUsernameAndPassword_ReturnErrorMessage422() {
    ...
    @Test
    public void createUser_WithInvalidPassword_ReturnErrorMessage422() {
        ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/users")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void createUser_WithDoubledUsername_ReturnErrorMessage409() {
        ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/users")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void searchUser_WithValidId_ReturnStatus200() {
    ...
    @Test
    public void searchUser_WithInvalidId_ReturnStatus404() {
        ErrorMessage responseBody = testClient
                .get()
                .uri("/api/v1/users/0")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@gmail.com", "123456"))
    ...
    @Test
    public void searchUser_WithClientSearchingAnotherClient_ReturnErrorMessageStatus403() {
        testClient
                .get()
    ...
    @Test
    public void updatePassword_ComDistinctUsers_ReturnErrorMessageStatus403() {
        testClient
                .patch()
                .uri("/api/v1/users/0")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@gmail.com", "123456"))
    ...
    @Test
    public void updatePassword_WithInvalidData_ReturnErrorMessageStatus422() {
        ErrorMessage responseBody = testClient
                .patch()
                .uri("/api/v1/users/100")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@gmail.com", "123456"))
    ...
    @Test
    public void updatePassword_WithInvalidData_ReturnErrorMessageStatus400() {
        ErrorMessage responseBody = testClient
                .patch()
                .uri("/api/v1/users/100")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@gmail.com", "123456"))
    ...
    @Test
    public void listUsers_withAdmin_ReturnUserListStatus200() {
    ...
    @Test
    public void listUsers_WithClient_ReturnErrorMessageStatus403() {
        testClient
                .get()
                .uri("/api/v1/users")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bia@gmail.com", "123456"))
